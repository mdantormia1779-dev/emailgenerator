...
import { CheckCircle2, Send, ExternalLink, ShieldCheck, ArrowRight, Briefcase } from 'lucide-react';
      ...
      <CardContent className="p-8 space-y-6">
        ...
        <div>
          ...
          <p className="text-sm text-slate-600 mt-1 max-w-md mx-auto">
            Your customized application for <strong>{jobTitle}</strong> at{' '}
            <strong>{companyName}</strong> has been transmitted via Gmail.
          </p>
        </div>
        ...
        <div className="p-3 rounded-lg bg-emerald-50/50 border border-emerald-100 text-xs text-emerald-800 flex items-center justify-center gap-2">
          ...
          <span>
            <strong>Duplicate Protection Active:</strong> Accidental re-sending of this application is locked.
          </span>
        </div>
